...
The goal of this project is to analyze employee data to understand why employees leave the company and identify patterns that impact retention and workforce stability.
...
* Improve employee satisfaction through better work environment and engagement strategies.
* Reduce excessive overtime to prevent burnout and turnover.
* Focus on early-stage employee experience and onboarding.
* Implement fair compensation and career growth opportunities.
* Strengthen manager-employee relationships, especially in early tenure stages.

---

## 🔗 Explore the Interactive Dashboard

[🔗 Explore the Interactive Dashboard](https://1drv.ms/x/c/e8b0d95267705a33/IQDg4ldO60piQJ9fZxkkhDMtAdNQ62XNBM8-m0RhhpcbmHo?e=ygDRJH)
